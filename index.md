...
hero:
  ...
  image:
    src: /assets/images/theme/vitepress-logo-large.svg
    alt: Jekyll VitePress Theme
    width: 320
    height: 320
...
features:
  ...
  - icon:
    ...
    details: Keep your Markdown, Liquid, YAML, and static hosting. Add the gem, set a few options, and publish.
  - icon:
      src: /assets/images/theme/turbo-frame-swap.svg
      alt: Turbo frame navigation
      width: 42
      height: 42
    title: Fast Docs Navigation
    details: Turbo Frames update the content area while the nav, sidebar, and shell stay mounted between docs pages.
  - icon:
