...
The gem ships everything needed to render a VitePress-like site and then adds Jekyll-first features beyond baseline VitePress. See [VitePress Parity](/vitepress-parity/) and [Extensions to VitePress](/extensions-to-vitepress/) for the full split:
...
For a detailed feature checklist, see [VitePress Parity](/vitepress-parity/). For optional features added on top of baseline VitePress, see [Extensions to VitePress](/extensions-to-vitepress/).
