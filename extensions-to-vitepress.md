...
- **[LLM discovery files](/configuration-reference/#llm-discovery):** generated `llms.txt` and `llms-full.txt` files covering canonical pages and documentation collections.
