...
Set `layout: home` in your page's frontmatter to render a landing page with a hero section and feature cards. Home pages do not show the sidebar or outline; they are full-width by design. See the [Frontmatter Reference]({% link _reference/frontmatter-reference.md %}) for all available home layout keys.
