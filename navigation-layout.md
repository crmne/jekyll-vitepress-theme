...
Documents can also form nested sidebar groups with Jekyll-style frontmatter. This documentation section uses that feature for its own [Nested Sidebar Items](/nested-sidebar-items/) page.
